...
enum uvc_xu_ctrl_selector {
  ...
  UVC_XU_CONTROL_CAMERA_FWUPGRADE = 0x12,
  UVC_XU_CONTROL_CAMERA_SHUTTER_SPEED = 0x13,
  UVC_XU_CONTROL_CAMERA_ISO = 0x14,
  UVC_XU_CONTROL_CAMERA_IRIS = 0x15,
  UVC_XU_CONTROL_CAMERA_WHITE_BALANCE = 0x16,
  UVC_XU_CONTROL_CAMERA_SHARPNESS = 0x17,
  UVC_XU_CONTROL_CAMERA_IMAGE_QUALITY = 0x18,
  UVC_XU_CONTROL_CAMERA_FOCUS = 0x19,
  UVC_XU_CONTROL_CAMERA_SPriority_ISO = 0x1A,
  UVC_XU_CONTROL_CAMERA_APriority_ISO = 0x1B,
  UVC_XU_CONTROL_CAMERA_FRAME_RATE= 0x1C,
};
